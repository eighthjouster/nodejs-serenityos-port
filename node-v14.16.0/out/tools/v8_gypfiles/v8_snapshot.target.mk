...
quiet_cmd__home_rafael_SerenityOS_serenity_Ports_nodejs_node_v14_16_0_tools_v8_gypfiles_v8_gyp_v8_snapshot_target_run_mksnapshot = ACTION generating: "$(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc" "$(obj).$(TOOLSET)/$(TARGET)/geni/embedded.S" $@
cmd__home_rafael_SerenityOS_serenity_Ports_nodejs_node_v14_16_0_tools_v8_gypfiles_v8_gyp_v8_snapshot_target_run_mksnapshot = LD_LIBRARY_PATH=$(builddir)/lib.host:$(builddir)/lib.target:$$LD_LIBRARY_PATH; export LD_LIBRARY_PATH; cd $(srcdir)/tools/v8_gypfiles; mkdir -p $(obj).$(TOOLSET)/v8_snapshot/geni; "$(builddir)/mksnapshot" --turbo_instruction_scheduling "--target_os=linux" "--target_arch=ia32" --startup_src "$(obj).$(TOOLSET)/v8_snapshot/geni/snapshot.cc" --embedded_variant Default --embedded_src "$(obj).$(TOOLSET)/v8_snapshot/geni/embedded.S" --no-native-code-counters
...
$(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc $(obj).$(TOOLSET)/$(TARGET)/geni/embedded.S: 61634c1d91c3554158e957f819b86dcc183d5d57.intermediate
	@:
.INTERMEDIATE: 61634c1d91c3554158e957f819b86dcc183d5d57.intermediate
61634c1d91c3554158e957f819b86dcc183d5d57.intermediate: $(builddir)/mksnapshot FORCE_DO_CMD
	$(call do_cmd,touch)
	$(call do_cmd,_home_rafael_SerenityOS_serenity_Ports_nodejs_node_v14_16_0_tools_v8_gypfiles_v8_gyp_v8_snapshot_target_run_mksnapshot)

all_deps += $(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc $(obj).$(TOOLSET)/$(TARGET)/geni/embedded.S
action__home_rafael_SerenityOS_serenity_Ports_nodejs_node_v14_16_0_tools_v8_gypfiles_v8_gyp_v8_snapshot_target_run_mksnapshot_outputs := $(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc $(obj).$(TOOLSET)/$(TARGET)/geni/embedded.S
...
$(OBJS): | $(action__home_rafael_SerenityOS_serenity_Ports_nodejs_node_v14_16_0_tools_v8_gypfiles_v8_gyp_v8_snapshot_target_run_mksnapshot_outputs)
...
$(obj).target/tools/v8_gypfiles/libv8_snapshot.a: | $(action__home_rafael_SerenityOS_serenity_Ports_nodejs_node_v14_16_0_tools_v8_gypfiles_v8_gyp_v8_snapshot_target_run_mksnapshot_outputs)

# Preserve order dependency of special output on deps.
$(action__home_rafael_SerenityOS_serenity_Ports_nodejs_node_v14_16_0_tools_v8_gypfiles_v8_gyp_v8_snapshot_target_run_mksnapshot_outputs): | $(obj).target/tools/v8_gypfiles/generate_bytecode_builtins_list.stamp $(obj).target/tools/v8_gypfiles/run_torque.stamp $(builddir)/mksnapshot $(obj).target/tools/v8_gypfiles/v8_maybe_icu.stamp $(obj).target/tools/v8_gypfiles/v8_compiler_for_mksnapshot.stamp
